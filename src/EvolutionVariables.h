...
class Spacetime
{
    public:
        ...
        double ricci_4_ctr() const; // Compute the 4D Ricci scalar at the grid center (r=0) 
        ...
        double E_flux_phi; // flux of complex scalar field energy across outer boundary
        double E_flux_psi; // flux of real scalar field energy across outer boundary
        
        void compute_scalar_energies(BSSNSlice* slice_ptr); // Compute scalar-field energies on a given slice and store in E_phi/E_psi
        void compute_energy_fluxes(BSSNSlice* slice_ptr); // Compute scalar-field energy fluxes across outer boundary and store in E_flux_phi/E_flux_psi
